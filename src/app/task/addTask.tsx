            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 ">
                <div className="bg-white w-full max-w-lg mx-4 rounded-lg shadow-lg h-66 overflow-y-auto">
                    ...
                    <div className="flex justify-between items-center p-4">
                        <h2 className="text-lg font-semibold">{id ? "Edit" : "Add"} Task</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                />
                                <p
                                    className={`text-xs text-red-500 mt-1 min-h-[1rem] ${errors.dueDate ? "visible" : "invisible"
                                        }`}
                                >
                            ...
                            <div>
                                ...
                                <p
                                    className={`text-xs text-red-500 mt-1 min-h-[1rem] ${errors.assignedTo ? "visible" : "invisible"
                                        }`}
                                >
