            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 ">
                <div className="bg-white w-full max-w-lg mx-4 rounded-lg shadow-lg h-66 overflow-y-auto">
                    ...
                    <div className="flex justify-between items-center p-4">
                        <h2 className="text-lg font-semibold">{id ? "Edit" : "Add"} Project</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                />
                                <p
                                    className={`text-xs text-red-500 mt-1 min-h-[1rem] ${errors.title ? "visible" : "invisible"
                                        }`}
                                >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {pmList.length > 0 && pmList.map((user) => (
                                ...
                                <p
                                    className={`text-xs text-red-500 mt-1 min-h-[1rem] ${errors.owner ? "visible" : "invisible"
                                        }`}
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                >
                                    {tmList.length > 0 && tmList.map((user) => (
                                        <option key={user._id} value={user._id}>
                                            {user.name}
                                        </option>
                                    ))}
                                ...
                                <p
                                    className={`text-xs text-red-500 mt-1 min-h-[1rem] ${errors.members ? "visible" : "invisible"
                                        }`}
                                >
